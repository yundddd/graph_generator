...
def graph_generator_py_test(name, **kwargs):
    """
...
def graph_generator_py_library(*args, **kwargs):
    """
    A pass-through macro for the upstream py_library rules.
    """
    py_library(*args, **kwargs)

def graph_generator_py_binary(name, **kwargs):
    """
    ...
    an additional py_binary using the container toolchain for use by `graph_generator_py_binary`.
...
def _py_layers(name, binary):
    ...
    Args:
        ...
        binary: The name of the graph_generator_py_binary to bundle in the container.
...
def graph_generator_py_image(name, binary, image_tags, tars = [], base = None, entrypoint = None, **kwargs):
    """
